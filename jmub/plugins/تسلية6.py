...
@jmub.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular jmub",
    },
)
...
@jmub.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catjmub is One of the Popular jmub",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@jmub.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular jmub",
    },
)
async def nekobot(cat):
...
@jmub.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular jmub",
    },
)
async def nekobot(cat):
